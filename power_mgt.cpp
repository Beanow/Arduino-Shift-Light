...
// Personal alternate calibration, by Beanow.
// Meant to prevent the second LED strip from glitching and bending towards red.
// For (WS2812B) in 2*8 led module configuration.
// Targeting max 600mW.
static const uint8_t gRed_mW   = 60;
static const uint8_t gGreen_mW = 35;
static const uint8_t gBlue_mW  = 22;
static const uint8_t gDark_mW  =  3;
